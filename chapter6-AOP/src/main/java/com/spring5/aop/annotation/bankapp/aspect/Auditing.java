package com.spring5.aop.annotation.bankapp.aspect;
...
public class Auditing {
    ...
    @Before("execution(* com.spring5.aop.annotation.bankapp.service.TransferService.transfer(..))")
    ...
    @AfterReturning("execution(* com.spring5.aop.annotation.bankapp.service.TransferService.transfer(..))")
    public void success(){
        System.out.println("bank successfully transferred amount");
    }
    //After failed transfer service
    @AfterThrowing("execution(* com.spring5.aop.annotation.bankapp.service.TransferService.transfer(..))")
